            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?php echo base_url('admin/supplier/tambah') ?>" class="btn btn-primary btn-round ml-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?php echo base_url('admin/supplier/edit/' . $row['supplier_id']) ?>">
                                                    <button type=" button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-sm" data-original-title="Edit Task">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                </a>
                                                <a href="<?php echo base_url('admin/supplier/hapus/' . $row['supplier_id']) ?>" onclick="return confirm('Yakin Hapus?')">
