...
<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="<?php echo base_url() ?>admin/produk/add" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" name="produk_nama" placeholder="" required value="<?php echo set_value('produk_nama'); ?>"> <?php echo form_error('produk_nama'); ?>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" name="produk_harga_beli" id="produk_harga_beli" placeholder="" required value="<?php echo set_value('produk_harga_beli'); ?>"> <?php echo form_error('produk_harga_beli'); ?>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
                                    <label for="inlineinput" class="col-md-3 col-form-label">Harga Jual</label>
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" name="produk_harga_jual" id="produk_harga_jual" placeholder="" required value="<?php echo set_value('produk_harga_jual'); ?>"> <?php echo form_error('produk_harga_jual'); ?>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
                                    <label for="inlineinput" class="col-md-3 col-form-label">Stok</label>
                                    <div class="col-md-9 p-0">
                                        <input type="text" class="form-control input-full" name="produk_stok" placeholder="" required value="<?php echo set_value('produk_stok'); ?>"> <?php echo form_error('produk_stok'); ?>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
                                    <label for="inlineinput" class="col-md-3 col-form-label">Deskripsi</label>
                                    <div class="col-md-9 p-0">
                                        <textarea class="ckeditor form-control input-full" id="ckeditor" name="produk_desk" required><?php echo set_value('produk_desk'); ?></textarea>
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="file" class="form-control input-full" name="produk_gambar" placeholder="" required value="<?php echo set_value('produk_gambar'); ?>"> <?php echo form_error('produk_gambar'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
